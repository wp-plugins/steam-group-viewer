				...
				<table width="100%">
					<tr>
						...
						<td align="right" valign="middle" width="35%" style="padding:0;border:0;">
							...
							text-align:center;">
							<a href="http://steamcommunity.com/groups/<?php echo $groupurl;?>" target="_BLANCK" style="text-decoration:none; display:block; color:white;width:100%; height:22px;line-height:22px;">Group</a></div></td>
					</tr>
				</table>
