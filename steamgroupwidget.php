...
{	
    ...
    {
        parent::__construct('steamgroup', 'Steam Group Widget', array('description' => 'Permet l affichage des informations importantes d un groupe steam de votre choix. Cree par Florian Chapon.'));
    }
